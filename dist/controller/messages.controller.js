...
let MessagesController = class MessagesController {
    ...
    async start(body, req) {
        return this.messagesService.startOrGetConversation(body.listing_id, req.user.userId, body.message);
    }
    async send(conversationId, body, req) {
...
__decorate([
    (0, common_1.Post)(':conversationId/send'),
